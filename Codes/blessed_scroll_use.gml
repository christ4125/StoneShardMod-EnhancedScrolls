...
with (interact_id) {
    if (image_alpha == 1) {
        ...
        var _rolls = irandom_range(4, 5);
        ds_map_set(data, "cursed_scroll_tier", "blessed");
        
        // FIXED: Swapped out the missing mod author function for the native vanilla layout routine
