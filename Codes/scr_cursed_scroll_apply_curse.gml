// Clean old curse states if they exist
...
if (_pool == 0)
{
    _curse = choose(
        "Curse_of_Gorelust",
        "Curse_of_Soulstealer",
        "Curse_of_Mindwrecker",
        "Curse_of_Everfear",
        "Curse_of_Gnawmaw",
        "Curse_of_Sufferjoy",
        "Curse_of_Loudmouth",
        "Curse_of_Goldhoarder",
        "Curse_of_AshenFeast"
    );
}
else
{
    _curse = choose(
        "Curse_of_CrimsonPact",
        "Curse_of_IronThirst",
        "Curse_of_GraveMercy",
        "Curse_of_StarvedFocus",
        "Curse_of_GlassHeart",
        "Curse_of_HollowVigor",
        "Curse_of_Boneward",
        "Curse_of_Misfortune"
    );
}

// Inject selected curse into the item metadata list
ds_list_add(curse_list, _curse, -4);

// --- STAT ATTRIBUTE ALLOCATIONS ---
switch (_curse)
{
...
// Standard setup rules for Cursed Item presentation properties
