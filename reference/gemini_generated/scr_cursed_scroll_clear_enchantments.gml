function scr_cursed_scroll_clear_enchantments()
{
    var _i = 0
    repeat (10)
    {
        var _key = ("Char" + string(_i))
    ...
    if (ds_map_exists(data, "cursed_scroll_tier"))
        ds_map_delete(data, "cursed_scroll_tier")
    if (ds_map_exists(data, "cursed_scroll_enchant_color"))
        ds_map_delete(data, "cursed_scroll_enchant_color")
    ...
    if (ds_map_exists(data, "Colour"))
        ds_map_delete(data, "Colour")
    event_user(7)
}