// --- Section Block 8 ---
event_inherited()
skill = o_skill_epic_enchantment_scroll
scr_consum_atr("scroll_epic_enchantment")
quality = (5 << 0)
ds_map_set(data, "quality", quality)
ds_map_set(data, "cursed_scroll_bg_color", make_colour_rgb(43, 35, 54))
ds_map_set(data, "cursed_scroll_bg_texture", make_colour_rgb(55, 43, 70))
ds_map_set(data, "cursed_scroll_bg_alpha", 0.25)
base_index = 5
image_blend = make_colour_rgb(154, 83, 235)

// --- Section Block 13 ---
event_inherited()
inv_object = o_inv_scroll_epic_enchantment
image_blend = make_colour_rgb(154, 83, 235)
...
with (interact_id)
{
    if (image_alpha == 1)
    {
        ...
        scr_cursed_scroll_random_enchant(3, 2, "epic")
        if inmouse
        {
